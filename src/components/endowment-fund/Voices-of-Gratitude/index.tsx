...
const index = () => {
  return (
    <div className="py-[54px] w-[90%] md:w-[80%] mx-auto">
      <h1 className="text-[30px] md:text-[50px] font-[500] text-[#111] mb-[10px] pb-[10px] py-[27px] leading-[60px] cinzel">
        Voices of Gratitude
      </h1>
      ...
      <div className="py-[27px] flex flex-wrap -mx-4 md:-mx-0">
        ...
        <div className="flex-1 min-w-[280px] md:w-[29%] px-4 md:px-0 md:mr-[60px] mb-8 md:mb-0">
          ...
          <div>
            <p className="text-[#0e0c19] text-[18px] mb-[10px] leading-[32px] font-[700] fauna-font">
            ...
            <p className="text-[#000000a3] text-[16px] mb-[10px] leading-[32px] font-[500] fauna-font">
              [Draft]
            </p>
          </div>
        </div>
