  ...
  return (
    <div>
      <section className="py-[54px] w-[90%] md:w-[80%] mx-auto">
        <h1 className="pt-[27px] mb-[10px] text-[32px] sm:text-[40px] md:text-[50px] text-[#111111] text-center font-[500] leading-[42px] sm:leading-[50px] md:leading-[60px] pb-[37px] cinzel">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center md:items-stretch mt-[40px] gap-[30px] md:gap-0">
          ...
          <div className="w-full md:w-[47.25%] md:mr-[60px]">
            <p className="text-[15px] sm:text-[16px] text-[#000000a3] font-[500] leading-[26px] sm:leading-[28px] text-center md:text-left fauna-font">
