    ...
    <div className="w-full pt-[60px] pb-[40px] bg-[#FCFCFC]">
      ...
      <div className="w-full max-w-[90%] md:max-w-[80%] py-4 mx-auto">
        ...
        <div className="text-center">
          ...
          <p className="text-[18px] font-[500] text-black pb-[1em] lato-font">
          ...
          <p className="text-[18px] font-[700] text-black mb-[50px] lato-font">
        ...
        <div className="bg-[#7EBEC5] py-[20px] md:py-[40px] md:px-[60px]  px-[30px] flex flex-col items-center justify-center text-center">
          ...
          <p className="text-[14px] font-[500] leading-[24px] text-white pb-[20px] aria-font">
      ...
      <div className="w-full max-w-[90%] mx-auto py-[3%] flex flex-col md:flex-row gap-8 md:gap-0">
        ...
        <div>
          <a
            ...
            className="inline-block px-6 py-3 text-[16px] font-bold text-white bg-[#007bff] rounded-md text-center no-underline transition-colors duration-300 ease-in-out hover:bg-[#0056B3] aria-font"
            target="_blank"
