...
export default function CharityValidationGuide() {
  return (
    <div className="pt-40 pb-12 bg-white min-h-screen aria-font">
      <div className="w-[90%] mx-auto md:max-w-[80%]">
        ...
        <section className="">
          ...
          <p className="text-[14px] font-[500] text-[#666] leading-[24px] pb-[1em]">
            ...
            benefits derived from each step of the validation process, emphasizing how these steps
            foster trust, enhance reputation, and facilitate growth for all parties involved.
          </p>
        </section>
            ...
            <li className="text-[14px] font-[500] text-[#666] leading-[24px]">
              ...
              <ol className="list-decimal list-inside ml-8 mt-2 space-y-1">
                ...
                <li>
                  ...
                  campaigns, and a reliable source of information for the public.
                </li>
              </ol>
            </li>
            ...
            <li className="text-[14px] font-[500] text-[#666] leading-[24px]">
              ...
              <ol className="list-decimal list-inside ml-8 mt-2 space-y-1">
                ...
                <li>
                  ...
                  communications, which is crucial for building trust with stakeholders and
                  maintaining efficient internal operations.
                </li>
              </ol>
            </li>
        ...
        <section className="mb-10">
          ...
          <p className="text-[14px] font-[500] text-[#666] leading-[24px]">
            ...
            increased trust among stakeholders. By adopting a multi-faceted validation approach, we
            ensure that our partnerships are with entities that are not only compliant but also
            effective, impactful, and aligned with the highest standards of non-profit excellence.
          </p>
        </section>
      </div>
    </div>
