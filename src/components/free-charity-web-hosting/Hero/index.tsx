    ...
    <section className="relative overflow-hidden pt-[150px] pb-[46px]">
      ...
      <div className="relative z-[5] w-[90%] max-w-[1300px] mx-auto flex flex-col md:flex-row items-start justify-between">
        ...
        <div className="w-full md:w-[38.2%] mb-8 md:mb-0 md:mr-[39px]">
          <h1 className="md:mt-[60px] mb-[20px] font-[700] text-[40px] md:text-[50px] leading-[50px] md:leading-[65px] text-[#1a2e35] cantata-font">
            Free For Charity <br />
            Hosting
          </h1>
          <p className="raleway-font text-[18px] md:text-[20px] font-[600] leading-[28px] md:leading-[30px]">
