    ...
    <div className="bg-[#fcfcfc] pt-[60px] pb-[25px] w-full max-w-[100%]">
      <div className="w-[90%] max-w-[90%] mx-auto py-[2%] items-center">
        ...
        <div className="mt-[20px] mb-[2.5%]">
          <p className="text-[18px] font-[500] color-black pb-[1em] lato-font">
          ...
          <p className="text-[18px] font-[500] color-black lato-font">
        ...
        <div className="mb-[70px]">
          <h1 className="text-[26px] font-[500] color-[#333] text-center pb-[10px] aria-font">
            Before You Begin Onboarding
          </h1>
          <h3 className="text-[14px] font-[700] underline text-center text-[#666] aria-font">
            Obtain the following information and materials ready to ensure you can complete the
            onboarding steps
          </h3>

          <ol className="text-[14px] font-[500] text-[#666] list-decimal list-outside space-y-3 pl-5 mb-[1em] aria-font">
        ...
        <AccordionItem number="1" title=" External Validation Preparation">
          <h1 className="font-[700] text-[18px] text-[#4A4A44] pb-[1em] underline lato-font">
            Before proceeding, ensure your charity agrees to use and sets up:
          </h1>
          <ol className="text-[18px] font-[500] text-[#4A4A44] list-decimal list-outside pl-5 pb-[23px] lato-font">
            <li>
        ...
        <AccordionItem number="2" title=" Free For Charity Onboarding Form">
          <h1 className="font-[700] text-[18px] text-[#4A4A44] pb-[1em] lato-font">
