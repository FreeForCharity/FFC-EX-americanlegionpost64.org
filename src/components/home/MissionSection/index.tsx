  ...
  return (
    <section className="py-16 px-4 sm:px-6 md:px-8 font-sans text-center">
      <div className="mx-auto w-full max-w-[1000px]">
        ...
        <p className="font-bold text-[16px] sm:text-[17px] md:text-[18px] leading-[26px] sm:leading-[27px] my-3 text-black px-2 sm:px-0 lato-font">
          Reduce costs and increase revenues for nonprofits; putting that money back into their
          charitable mission where it belongs.
        </p>

        <p className="font-medium text-[16px] sm:text-[17px] md:text-[18px] leading-[26px] sm:leading-[27px] text-black px-2 sm:px-0 lato-font">
