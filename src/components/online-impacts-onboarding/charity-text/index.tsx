    ...
    <div className="w-full bg-[#FCFCFC]">
      <div className="w-full max-w-[90%] mx-auto pt-[20px]">
        <HelpForCharities
          ...
          description=""
        />
        <h1 className="text-[26px] font-[500] text-[#333] my-[20px] lato-font">
          Lets get started on your transfer today
        </h1>
        <p className="text-[18px] font-[500] pb-[1em] lato-font">
        ...
        <p className="text-[18px] font-[500] lato-font">
        ...
        <h1 className="text-[23px] sm:text-[26px] font-[500] text-[#333] my-[20px] leading-[1.4] lato-font">
        ...
        <h1 className="text-[26px] font-[500] text-[#333] mt-[20px] lato-font">
          Before You Begin Onboarding
        </h1>
        <p className="text-[18px] font-[600] text-[#666] abeezee">
          Obtain the following information and materials ready to ensure you can complete the
          onboarding steps:
        </p>
        <ol className="text-[18px] mb-[50px] font-[600] text-[#666] list-decimal list-inside  abeezee">
        ...
        <AccordionItem number="2" title="Free For Charity Onboarding Form">
          {/* Step 1 */}
          <h1 className="text-[18px] font-[700] text-[#4a4a4a] mb-[1em] lato-font">
